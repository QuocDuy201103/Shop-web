...
<style>
    ...
    .edit-user {
        ...
        /* background-color: linear-gradient(-135deg, #14224c, #3d4d6a); */
        color: #000;
        border-radius: 4px;
    ...
    <div class="home-content">
        <div class="row ">
            ...
            <div class="row frmcontent">
                ...
                <!-- modal nhap them-->
                <form class="modal js-modal" method="post" action="index.php?act=themnguoidung">
                    <div class="modal-container js-modal-container">
                        <div class="modal-close js-modal-close">
                            <i class="bi bi-x-circle"></i>
                        </div>
                        <header class="modal-heading">
                            <i class="modal-heading-icon fa-solid fa-suitcase"></i>Thêm tài khoản người dùng
                        </header>
                        <div class="modal-body">
                            <label for="modal-ticket-user" class="modal-label">
                                <i class="bi bi-postcard"></i>
                                Họ và tên</label>
                            <input type="text" id="modal-ticket-user" class="modal-input" name="fullname">

                            <label for="modal-ticket-address" class="modal-label">
                                <i class="bi bi-house"></i>
                                Địa chỉ</label>
                            <input type="modal-email" id="modal-ticket-address" class="modal-input" name="address">

                            <label for="modal-ticket-date" class="modal-label">
                                <i class="bi bi-calendar"></i>
                                Tên đăng nhập</label>
                            <input type="modal-email" id="modal-ticket-date" class="modal-input" name="username">

                            <label for="modal-ticket-gender" class="modal-label">
                                <i class="bi bi-gender-ambiguous"></i>
                                Mật khẩu</label>
                            <input type="password" id="modal-password" class="modal-input" name="password">
                            ...
                            <label for="modal-ticket-phone" class="modal-label">
                                ...
                                Số điện thoại</label>
                            <input type="text" id="modal-ticket-phone" class="modal-input" name="phonenumber">

                            <label for="modal-ticket-phone" class="modal-label">
                                <i class="bi bi-phone-vibrate"></i>
                                Email</label>
                            <input type="text" id="modal-ticket-phone" class="modal-input" name="email">

                            <input id="buy-ticket-edit" type="submit" name="adduser" value="Thêm người dùng mới">
                        </div>
                    </div>
                </form>
                <!-- end modal nhap them -->
