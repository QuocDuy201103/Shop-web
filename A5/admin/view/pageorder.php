...
<section class="home-section">
    <nav id="header">
        <div class="sidebar-button">
            ...
            <span class="dashboard">Quản Lý Đơn Hàng</span>
        </div>
        <div id="nav">
            <li>
                    ...
                    <table style="border-collapse:collapse;text-align:center;">
                        ...
                        if (isset($orders)) {
                            foreach ($orders as $order) {
                                ...
                                <td>' . $fullname . '</td>
                                <td>' . $txt . '</td>
                                <td><a class="detailorder" href="index.php?act=detailorder&id=' . $order['id'] . '">Xem chi tiết</a>';
                                if ($status == 'pending') {
                                    echo '<a class="detailorder" style="margin-left:4px;" href="index.php?act=confirmed&id=' . $order['id'] . '">Xác nhận đơn</a></td>';
                                }
